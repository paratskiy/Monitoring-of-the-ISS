...
function initMap() {
    ...
    let myLatLng = { lat: +locationData.iss_position.latitude, lng: +locationData.iss_position.longitude };
    ...
    function moveISS() {
        marker.setPosition(new google.maps.LatLng(+locationData.iss_position.latitude, +locationData.iss_position.longitude));
